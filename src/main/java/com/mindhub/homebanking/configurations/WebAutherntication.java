...
@Configuration
public class WebAutherntication extends GlobalAuthenticationConfigurerAdapter {
    ...
    public void init(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.userDetailsService(inputName-> {
            ...
            Client client = this.clientRepository.findByEmail(inputName);

            if (client != null) {
                if (client.getFirstName().contains("ADMIN")||client.getLastName().equals("ADMIN")){
